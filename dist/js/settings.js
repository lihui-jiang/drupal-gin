  ...
  Drupal.behaviors.ginSettings = {
    ...
    init: function(context) {
      context.querySelectorAll('input[name="enable_darkmode"]').forEach((el => el.addEventListener("change", (e => {
        ...
        ("always" == drupalSettings.gin.darkmode_localstorage || "adminpath" == drupalSettings.gin.darkmode_localstorage && drupalSettings.path.currentPathIsAdmin) && localStorage.setItem("Drupal.gin.darkmode", darkmodeEnabled);
      }));
    },
    darkmode: function() {
